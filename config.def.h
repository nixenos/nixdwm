...
/* catpuccino colors */
static char black[]       = "#1B1923";
static char gray2[]       = "#3E4058"; // unfocused window border
static char gray3[]       = "#6E6C7C";
static char gray4[]       = "#15121C";
static char blue[]        = "#A4B9EF";  // focused window border
static char green[]       = "#B3E1A3";
static char red[]         = "#E28C8C";
static char orange[]      = "#F7C196";
static char yellow[]      = "#EADDA0";
static char pink[]        = "#ECBFBD";
static char col_borderbar[]  = "#1B1923"; // inner border
...
static char *fonts[]          = { "JetBrainsMono Nerd Font:style:medium:size=9", "Material Design Icons-Regular:size=9", "FontAwesome:size=9" };
...
static Key keys[] = {
	...
	{ 0,				XK_Print,	spawn,		SHCMD("maim Pictures/Screenshots/screentshot-$(date '+%y%m%d-%H%M-%S').png") },
	{ ShiftMask,			XK_Print,	spawn,		SHCMD("maim -s Pictures/Screenshots/screentshot-$(date '+%y%m%d-%H%M-%S').png") },
	...
	{ 0, XF86XK_Battery,		spawn,		SHCMD(TERMINAL "-e powertop") },
	{ 0, XF86XK_Launch1,		spawn,		SHCMD("sudo toggle-superspeed-mode") },
